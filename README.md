...
jb-ape scenarios                     # 15 preset scenarios, 9 problem classes
...
## Scenario catalog (15 presets / 9 problem classes)
...
inside a **393-test** offline suite (no network, no LLM, no browser).
...
src/jb_ape/        the engine — models · facade · generator · planner · dtree
                   ...
                   ui (local web GUI)
tests/             393 offline tests, incl. 19 signal-contract tests
